...
- Avatar customization: environment presets, character presets, default Ready Player Me avatar, and GLB/GLTF upload.
...
- Visual Studio mini-apps for Stable Diffusion (txt2img) and ComfyUI workflows.
